...
#Nodes
addnode=159.65.32.195
addnode=159.89.185.177
addnoe=165.227.183.91
addnode=68.183.146.25
addnode=134.209.165.157
addnode=159.65.170.43
EOF
}
...
libminiupnpc-dev libgmp3-dev ufw pkg-config libevent-dev libdb5.3++ unzip libzmq5 htop fail2ban >/dev/null 2>&1
if [ "$?" -gt "0" ];
  then
...
bsdmainutils libdb4.8++-dev libminiupnpc-dev libgmp3-dev ufw pkg-config libevent-dev libdb5.3++ unzip libzmq5 htop fail2ban"
 exit 1
fi
clear
}
